...
export const metadata: Metadata = {
  title: "PRD 知识库",
  description: "PRD 业务规则提取与管理平台",
};

const nav = [
  { href: "/upload", label: "文档库", icon: "doc.badge.plus" },
  { href: "/rules", label: "规则库", icon: "list.bullet.rectangle" },
  { href: "/review", label: "规则审核", icon: "checkmark.shield" },
  { href: "/risks", label: "逻辑规则冲突处理", icon: "exclamationmark.shield" },
  { href: "/health", label: "数据使用情况", icon: "heart.text.square" },
];
      ...
      <body className="h-full flex text-[var(--foreground)]" style={{ background: "var(--background)" }}>
        <aside className="w-[220px] sidebar-glass flex flex-col shrink-0 h-full">
          <div className="px-5 pt-6 pb-4">
            <h1 className="text-[15px] font-semibold tracking-tight">PRD 知识库</h1>
            <p className="text-[11px] mt-0.5" style={{ color: "var(--muted)" }}>业务规则管理平台</p>
          </div>
